		...
		var form = {
			...
			initialize: function() {
				...
				$form.validate({
					...
					messages: {
						val_email: {
							required:"<span class='form-message-error'>Inserisci il tuo indirizzo mail!</span>",
							email:"<span class='form-message-error'>Inserisci un indirizzo mail valido!</span>"
						},
						val_subject: {
							required:"<span class='form-message-error'>Questo campo è necessario!</span>"
						},
						val_message: {
							required: "<span class='form-message-error'>Questo campo è necessario!</span>"
						}
